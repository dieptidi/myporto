...
2. ASP.Net (Frontend Web | Sql)
3. CodeIgniter / Laravel (Frontend/Backend Web | Sql)
4. Vue Js (Frontent Web | NoSql)
5. Node Js (Backend Web | NoSql)
6. Unity 2d & 3d (Game Development | C#)
7. Unreal Engine (Game Development | C++)
